...
- (UIImageView*)scrollViewPage:(NSDictionary*)imageDict
{
    UIImageView *imageView = [[UIImageView alloc] init];
    //imageView.image = [UIImage imageNamed:(NSString*)imageDict];
   [imageView sd_setImageWithURL:[NSURL URLWithString:[imageDict objectForKey:@"img"]] placeholderImage:[UIImage imageNamed:@"Default"]];
