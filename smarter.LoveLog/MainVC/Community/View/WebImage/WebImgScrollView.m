...
- (UIButton *)downLoadBtn{
    if (_downLoadBtn == nil) {
        ...
        _downLoadBtn.left = kScreenWidth - 50;
        _downLoadBtn.top = kScreenHeight - 40;
...
-(UILabel *)countLabel
{
    if (!_countLabel) {
        ...
        _countLabel.font = DefaultFontSize(15);
        _countLabel.left = KLeft*2;
        _countLabel.top = kScreenHeight-40;
