...
- (void)viewDidLoad {
    ...
    [_setNavigationView initViewWithTitle:@"帮助中心" andBack:@"icon_back.png" andRightName:@""];
    __WEAK_SELF_YLSLIDE
...
-(void)getData
{
    [UserInfoTool userInfo:@"/help/index" params:nil success:^(id obj) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HelpNextViewController * nextVC =[[HelpNextViewController alloc] init];
